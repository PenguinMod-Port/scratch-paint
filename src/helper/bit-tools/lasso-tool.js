...
import SelectionLassoTool from '../selection-tools/selection-lasso-tool';
...
class LassoTool extends paper.Tool {
    ...
    constructor (setSelectedItems, clearSelectedItems, setCursor, onUpdateImage) {
        ...
        this.selectionLassoTool = new SelectionLassoTool(Modes.BIT_LASSO, setSelectedItems, clearSelectedItems, LassoTool.MIN_DISTANCE);
    ...
    handleMouseUp (event) {
        ...
        if (this.selectionLassoMode) {
            this.selectionLassoTool.onMouseUpBitmap(event);
        } else {
