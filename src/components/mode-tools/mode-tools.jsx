...
const ModeToolsComponent = props => {
    const messages = defineMessages({
        ...
        brushSmoothing: {
            ...
            id: 'paint.modeTools.brushSmoothing'
        },
        eraserSize: {
        ...
        eraserSmoothing: {
            ...
            id: 'paint.modeTools.eraserSmoothing'
        },
        brushCircle: {
